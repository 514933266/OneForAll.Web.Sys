  ...
  <div class="ofa-container column">
    <el-card shadow="never">
      <div class="ofa-work-box">
        ...
        <span>
          <search-input enterable v-model="searchOption.key" @click="get" placeholder="输入标题搜索" size="mini">
          </search-input>
        </span>
      </div>
    </el-card>
    <el-card shadow="never" class="table-card">
      <!-- 主体内容 -->
      <el-table border :data="list" v-loading="loading" size="mini" class="base-table">
        ...
        <el-table-column label="操作" width="160" align="center" header-align="center">
          <template slot-scope="scope">
            ...
            <el-button v-if="!scope.row.IsPublish" type="text" size="mini" @click="publish(scope.row)">发布</el-button>
