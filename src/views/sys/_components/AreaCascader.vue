<template>
  <el-cascader ref="list" v-model="treePath" :options="list" :placeholder="placeholder" :size="size"
    :props="{ children: 'Children', value: 'Id', label: 'Name', checkStrictly: true, lazy: true, lazyLoad: this.getChildren }">
