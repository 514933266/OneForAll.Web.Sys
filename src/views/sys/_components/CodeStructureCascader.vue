<template>
  <el-cascader ref="codeStructureCascader" :props="{ children: 'Children', value: 'Id', label: 'Name', checkStrictly: true }" v-model="treePath"
    :options="tree" :placeholder="placeholder" size="mini"></el-cascader>
</template>
...
export default {
  ...
  methods: {
    ...
    getCheckedNodes () {
      return this.$refs.codeStructureCascader.getCheckedNodes()
    }
  },
  created () {
    this.init()
