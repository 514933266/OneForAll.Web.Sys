<template>
  <div class="ofa-form">
    <el-card content-position="left" class="form-header" shadow="never">
      <el-page-header @back="goBack" content="菜单管理 Menu" size="mini"></el-page-header>
    ...
    <div class="form-content">
            ...
            <div class="info-box">
              ...
              <div class="row">
                <el-form-item label="备注" prop="Remark" class="remark-item">
                  <el-input show-word-limit v-model="entity.Remark" type="textarea" class="remark-textarea"
                    placeholder="请输入菜单备注" maxlength="300">
                  </el-input>
                </el-form-item>
              </div>
            </div>
      ...
      <!-- 权限 -->
      <el-card v-if="!entity.isAdd" content-position="left">
        <div slot="header" class="perms-header">
          ...
          <span>
            ...
            <el-button @click="deletePermission"
              class="ofa-button ofa-button-danger">
