<template>
  <div class="menu-perms-box">
    <el-table border :data="list" @selection-change="selectionChange" size="mini" class="perm-table">
      ...
      <el-table-column prop="Name" label="名称">
        <template slot-scope="scope">
          ...
          <el-input v-else v-model="scope.row.Name" size="mini" placeholder="必填，请输入权限名称">
          </el-input>
        </template>
      </el-table-column>
      <el-table-column prop="Code" label="代码">
        <template slot-scope="scope">
          ...
          <el-input v-else v-model="scope.row.Code" size="mini" placeholder="必填，请输入权限代码">
          </el-input>
        </template>
      </el-table-column>
      <el-table-column prop="SortCode" label="排序代码">
        <template slot-scope="scope">
          ...
          <el-input v-else v-model="scope.row.SortCode" size="mini" placeholder="请输入排序号">
          </el-input>
        </template>
      </el-table-column>
      <el-table-column prop="Remark" label="备注">
        <template slot-scope="scope">
          ...
          <el-input v-else v-model="scope.row.Remark" size="mini" placeholder="请输入权限备注"></el-input>
        </template>
      </el-table-column>
    ...
    <!-- 弹窗 -->
    <el-dialog :visible.sync="dialogVisible" title="克隆权限" width="80%" size="mini">
